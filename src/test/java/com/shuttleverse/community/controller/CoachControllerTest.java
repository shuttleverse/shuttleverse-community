...
class CoachControllerTest {
  ...
  void addSchedule_Success() {
    ...
    doReturn(schedules).when(coachService).addSchedule(any(UUID.class), any(List.class));
    ...
    verify(coachService).addSchedule(coachId, schedules);
  }
  ...
  void addCoachWithSchedule_Success() {
    ...
    when(userService.findBySub(any(String.class))).thenReturn(Optional.of(user));
    when(coachService.createCoach(any(Coach.class), any(User.class))).thenReturn(coach);
    doReturn(List.of(schedule)).when(coachService).addSchedule(any(UUID.class), any(List.class));
    ...
    verify(coachService).createCoach(any(Coach.class), any(User.class));
    verify(coachService).addSchedule(any(UUID.class), any(List.class));
  }
